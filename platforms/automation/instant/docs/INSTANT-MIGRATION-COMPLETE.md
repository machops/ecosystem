...
- **目標位置**: `ns-root/namespaces-mcp/refactor_playbooks/`
...
```
ns-root/namespaces-mcp/refactor_playbooks/
...
### 核心文檔
- **遷移清單**: `ns-root/namespaces-mcp/refactor_playbooks/INSTANT_MIGRATION_MANIFEST.yaml`
- **遷移通知**: `ns-root/namespaces-mcp/refactor_playbooks/MIGRATION_NOTICE.md`
- **INSTANT 指南**: `ns-root/namespaces-mcp/refactor_playbooks/README_INSTANT.md`
- **舊位置通知**: `workspace/docs/refactor_playbooks/MOVED.md`

### 索引文檔
- **NAMESPACE_INDEX**: `ns-root/namespaces-mcp/NAMESPACE_INDEX.yaml`
- **INTEGRATION_INDEX**: `ns-root/namespaces-mcp/INTEGRATION_INDEX.yaml`
...
- ✅ 所有檔案已遷移至 `ns-root/namespaces-mcp/refactor_playbooks/`
- ✅ 所有路徑引用已更新
- ✅ 所有索引已整合
- ✅ 所有驗證已通過
- ✅ 所有文檔已創建
